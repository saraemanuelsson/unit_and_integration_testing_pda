...
describe('calculator functionality', function() {
  ...
  it("should update display when number button is clicked", function(){
    running_total = element(by.css('#running_total'));
  ...
  it("should update display with result of chained operations", function(){
    running_total = element(by.css('#running_total'));
    element(by.css('#number1')).click();
    element(by.css('#operator_add')).click();
    element(by.css('#number9')).click();
  ...
  it("should be able to handle large numbers", function(){
    ...
    element(by.css('#number9')).click();
    element(by.css('#operator_equals')).click();
    expect(running_total.getAttribute('value')).to.eventually.equal('899999991');
  })
  ...
  it("should display undefined when divided by 0", function(){
    running_total = element(by.css('#running_total'));
    element(by.css('#number1')).click();
    element(by.css('#operator_divide')).click();
